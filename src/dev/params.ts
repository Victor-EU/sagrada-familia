...
export function buildPanel(ctx: ParamContext): Pane {
  ...
  towers.addBinding(ctx.plan.towers, 'bands', { min: 2, max: 24, step: 1, label: 'aperture rows' })
  ...
  towers.addBinding(ctx.plan.towers, 'helix', { min: -3, max: 3, step: 0.25, label: 'helix bays' })
